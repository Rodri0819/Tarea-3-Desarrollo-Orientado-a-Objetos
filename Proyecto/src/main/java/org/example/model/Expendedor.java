...
public class Expendedor {
    ...
    public int getNumeroDeCocas() {
        return productos.get(COCA - 1).size();
    }

    public int getNumeroDeSprites() {
        return productos.get(SPRITE - 1).size();
    }

    public int getNumeroDeFantas() {
        return productos.get(FANTA - 1).size();
    }

    public int getNumeroDeSuper8s() {
        return productos.get(SUPER8 - 1).size();
    }
